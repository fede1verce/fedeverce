...
namespace GeneXus.Programs.wwpbaseobjects {
   public class savefilteras : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202191511541960", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table1_2_0E2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_5_0E2( true) ;
         }
         else
         {
            wb_table2_5_0E2( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_0E2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_5_0E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_11_0E2( true) ;
         }
         else
         {
            wb_table3_11_0E2( false) ;
         }
         return  ;
      }

      protected void wb_table3_11_0E2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_0E2e( true) ;
         }
         else
         {
            wb_table2_5_0E2e( false) ;
         }
      }

      protected void wb_table3_11_0E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_11_0E2e( true) ;
         }
         else
         {
            wb_table3_11_0E2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202191511541974", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/savefilteras.js", "?202191511541974", false, true);
