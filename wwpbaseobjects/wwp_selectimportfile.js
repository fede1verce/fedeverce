...
gx.define('wwpbaseobjects.wwp_selectimportfile', false, function () {
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV13Ret=gx.fn.getControlValue("vRET") ;
   };
   this.e120k2_client=function()
   {
      return this.executeServerEvent("'DOUCANCEL'", false, null, false, false);
   };
   ...
   GXValidFnc[22]={ id: 22, fld:"BTNENTER",grid:0,evt:"e130k2_client",std:"ENTER"};
   GXValidFnc[23]={ id: 23, fld:"",grid:0};
   GXValidFnc[24]={ id: 24, fld:"BTNUCANCEL",grid:0,evt:"e120k2_client"};
   ...
   this.AV5ErrorMsgs = [ ] ;
   this.AV13Ret = false ;
   this.Events = {"e120k2_client": ["'DOUCANCEL'", true] ,"e130k2_client": ["ENTER", true] ,"e160k2_client": ["CANCEL", true]};
   this.EvtParms["REFRESH"] = [[{av:'AV13Ret',fld:'vRET',pic:''},{av:'AV5ErrorMsgs',fld:'vERRORMSGS',pic:'',hsh:true},{av:'AV9ImportType',fld:'vIMPORTTYPE',pic:'',hsh:true},{av:'AV6ExtraParmsJson',fld:'vEXTRAPARMSJSON',pic:'',hsh:true},{av:'AV14TransactionName',fld:'vTRANSACTIONNAME',pic:'',hsh:true}],[]];
   this.EvtParms["START"] = [[],[]];
   this.EvtParms["'DOUCANCEL'"] = [[],[{av:'AV13Ret',fld:'vRET',pic:''}]];
   this.EvtParms["ENTER"] = [[{ctrl:'vFILTERTOUPLOAD',prop:'Filename'},{av:'AV7FilterToUpload',fld:'vFILTERTOUPLOAD',pic:''},{av:'AV9ImportType',fld:'vIMPORTTYPE',pic:'',hsh:true},{av:'AV5ErrorMsgs',fld:'vERRORMSGS',pic:'',hsh:true},{av:'AV6ExtraParmsJson',fld:'vEXTRAPARMSJSON',pic:'',hsh:true},{av:'AV14TransactionName',fld:'vTRANSACTIONNAME',pic:'',hsh:true}],[{av:'AV13Ret',fld:'vRET',pic:''},{av:'AV7FilterToUpload',fld:'vFILTERTOUPLOAD',pic:''}]];
   ...
   this.setVCMap("AV13Ret", "vRET", 0, "boolean", 4, 0);
   this.Initialize( );
});
gx.wi( function() { gx.createParentObj(wwpbaseobjects.wwp_selectimportfile);});
