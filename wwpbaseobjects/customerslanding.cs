...
namespace GeneXus.Programs.wwpbaseobjects {
   public class customerslanding : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202191511542146", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCustomerstitle_Internalname, "Customers", "", "", lblCustomerstitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "LandingPurusTitleWhite", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects\\CustomersLanding.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCustomersinfo_Internalname, "Some of the companies that have relied on us", "", "", lblCustomersinfo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "LandingPurusSubtitleGray", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects\\CustomersLanding.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 21 )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTestimonialstitle_Internalname, "Testimonials", "", "", lblTestimonialstitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "LandingPurusTitleWhiteWithUnderline", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects\\CustomersLanding.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      protected void START0M2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Customers Landing", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202191511542186", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpbaseobjects/customerslanding.js", "?202191511542186", false, true);
            context.AddJavascriptSource("HorizontalGrid/horizontalgrid.min.js", "", false, true);
            context.AddJavascriptSource("HorizontalGrid/horizontalgrid.min.js", "", false, true);
         }
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Customers Landing";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FSTESTIMONIALS.LOAD","{handler:'E130M3',iparms:[]");
         setEventMetadata("FSTESTIMONIALS.LOAD",",oparms:[]}");
         setEventMetadata("CUSTOMERSGRID.LOAD","{handler:'E120M2',iparms:[]");
