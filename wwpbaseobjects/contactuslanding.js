...
gx.define('wwpbaseobjects.contactuslanding', false, function () {
   this.ServerClass =  "wwpbaseobjects.contactuslanding" ;
   ...
   GXValidFnc[42]={ id: 42, fld:"BTNENTER",grid:0,evt:"e120l2_client",std:"ENTER"};
   this.AV5Name = "" ;
   this.ZV5Name = "" ;
   this.OV5Name = "" ;
   this.AV6Email = "" ;
   ...
   this.AV7Subject = "" ;
   this.AV8Message = "" ;
   this.Events = {"e120l2_client": ["ENTER", true] ,"e140l2_client": ["CANCEL", true]};
...
gx.wi( function() { gx.createParentObj(wwpbaseobjects.contactuslanding);});
